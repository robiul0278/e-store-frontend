      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 ">
        {categories.map((category, idx) => (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex flex-col items-center justify-center p-6 bg-white dark:bg-gray-800 shadow-md rounded-2xl border hover:shadow-xl transition-all duration-300 cursor-pointer"
          >
